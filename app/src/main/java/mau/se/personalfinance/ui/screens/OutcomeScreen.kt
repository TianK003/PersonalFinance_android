...
import mau.se.personalfinance.viewmodels.OutcomeViewModel
...
fun OutcomeScreen(
    ...
    val outcomes by viewModel.sortedOutcomes.collectAsState(emptyList())
                    ...
                    Row(
                        ...
                        Box(
                            ...
                            DropdownMenu(
                                ...
                                OutcomeViewModel.SortType.entries.forEach { sortType ->
                                    DropdownMenuItem(
                                        text = { Text("By ${sortType.name.lowercase().replaceFirstChar { it.uppercase() }}") },
                                        onClick = {
        ...
        LazyColumn(contentPadding = padding) {
            items(outcomes) { outcome ->
                TransactionRow(
                    ...
                    onDelete = { viewModel.deleteOutcome(outcome) }
                )
            }
        }
    }
